...
The rest of this README documents the raw CLI for direct/scripted use.
...
Steps 1–4 are driven by the two Claude Code skills above; see the
`Semantic view builder` section below for the equivalent raw CLI commands if
you're scripting this outside Claude Code.
